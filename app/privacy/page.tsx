    ...
    >
      <div className="space-y-6">
        ...
        <section className="space-y-2">
          ...
          <p className="text-slate-600 dark:text-slate-300 text-xs sm:text-sm">
            <strong>Storage Limitation &amp; Data Retention Policy:</strong> In accordance with the storage limitation principle of UK GDPR (Article 5(1)(e)), personal data of minors is retained only for as long as necessary for educational tuition. An <em>Inactive</em> status indicates a temporary break (such as summer holidays, half-term breaks, or a short-term pause in tuition) and does not mark a profile for deletion. However, where a student profile has conducted no lessons for a prolonged period (by default 90 days with no future lessons scheduled), the profile is automatically flagged for deletion on the administrator portal for review and permanent erasure, ensuring minor student credentials, names, and logs are never retained indefinitely.
          </p>
          <p className="text-slate-600 dark:text-slate-300 text-xs sm:text-sm">
